...
Public Class Clientes
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If TextBox6.Text.Length = 0 Then
            MessageBox.Show("Debe Ingresar Apellidos", "Atención", MessageBoxButtons.OK, MessageBoxIcon.None)
            TextBox6.Focus()
            Exit Sub
        End If
        If TextBox2.Text.Length = 0 Then
            MessageBox.Show("Debe Ingresar NIT", "Atención", MessageBoxButtons.OK, MessageBoxIcon.None)
            TextBox2.Focus()
            Exit Sub
        End If
        If TextBox3.Text.Length = 0 Then
            MessageBox.Show("Debe Ingresar Teléfono", "Atención", MessageBoxButtons.OK, MessageBoxIcon.None)
            TextBox3.Focus()
            Exit Sub
        End If
        If TextBox2.Text.Length < 8 Then
            MessageBox.Show("Debe Ingresar un NIT Valido", "Atención", MessageBoxButtons.OK, MessageBoxIcon.None)
            TextBox2.Focus()
            Exit Sub
        End If
        If TextBox2.Text.Length < 8 Then
